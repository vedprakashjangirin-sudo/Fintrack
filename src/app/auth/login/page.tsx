    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-[#475569] mt-2">Sign in to your household</p>
        </div>
        ...
        <form action={login} className="space-y-4">
          ...
          <button 
            type="submit"
            className="w-full bg-[#0F172A] text-white py-2.5 rounded-lg hover:bg-[#1e293b] transition-colors font-medium"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="mt-6 text-center text-sm text-[#475569]">
          ...
          <Link href="/auth/signup" className="text-[#0F172A] font-medium hover:underline">
            Create household
          </Link>
        </div>
      </div>
